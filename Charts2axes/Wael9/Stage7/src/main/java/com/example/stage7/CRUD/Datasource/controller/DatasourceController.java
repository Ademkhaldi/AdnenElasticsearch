...
/*
    ...
    */
    ...
    @GetMapping("/histogramme/{chartId}")
    public ResponseEntity<List<Map<String, Object>>> gethistogrammeData(
            @PathVariable("chartId") String chartId) {
        ...
        // Appeler la méthode camambert avec les paramètres extraits du Chart
        List<Map<String, Object>> chartData = elasticService.histogramme(
                datasource,
                chart.getIndex(),
                chart.getX_axis(),
                chart.getY_axis()
