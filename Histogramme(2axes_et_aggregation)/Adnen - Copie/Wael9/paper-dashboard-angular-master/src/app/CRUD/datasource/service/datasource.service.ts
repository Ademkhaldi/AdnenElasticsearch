...
getHistogrammeData(chartId: string): Observable<any> {
  return this.http.get<any>(`${this.apiUrl}/histogramme/${chartId}`);
}

getHistogramme2(chartId: string): Observable<any> {
  return this.http.get<any>(`${this.apiUrl}/histogramme2/${chartId}`);
}
