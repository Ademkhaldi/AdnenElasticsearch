...
import { ChartDataComponent } from 'app/CRUD/datasource/chart-data/chart-data.component';
import { HistogrammeComponent } from 'app/CRUD/datasource/histogramme/histogramme.component';
import { Histogramme2Component } from 'app/histogramme2/histogramme2.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'ChartDataComponent/:id', component: ChartDataComponent },

    { path: 'HistogrammeComponent/:id', component: HistogrammeComponent },
